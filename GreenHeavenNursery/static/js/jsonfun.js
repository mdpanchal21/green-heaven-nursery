  ...
  $('.in-search').on('input',function(){
       ...
       if (val.length > 0) {
          $.ajax({
              ...
              success: function(response) {
                  if(Object.keys(response.results1).length === 0 && Object.keys(response.results2).length === 0 && Object.keys(response.results3).length === 0){
                      $('#search-items').hide();
          
                  }else{
                      displayResults(response.results3,response.results1,response.results2);
                  }
      ...
      function displayResults(results3,results1,results2) {
          var resultHtml = '';
          var url='';
          ...
          results3.forEach(function(subcategory) {
              console.log(subcategory);
              url = '/productList/'+subcategory.sid+"/"+subcategory.id;
              resultHtml += '<li class="search-contain"><a href="'+url+'">'+subcategory.name+'</a></li>';
